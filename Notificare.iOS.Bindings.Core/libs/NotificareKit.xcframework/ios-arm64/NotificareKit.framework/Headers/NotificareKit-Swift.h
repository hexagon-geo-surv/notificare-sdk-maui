...
#ifndef NOTIFICAREKIT_SWIFT_H
#define NOTIFICAREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotificareKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("NotificareCoreDataEvent")
@interface NotificareCoreDataEvent : NSManagedObject
...
@property (nonatomic) int16_t retries;
